...
def format_device_status(
    ...
    status = {
        ...
        "capabilities": {
            ...
            "has_emer_heat": shared_values.get("has_emer_heat", device_values.get("has_emer_heat", False)),
            "has_humidifier": shared_values.get("has_humidifier", device_values.get("has_humidifier", False)),
            "has_dehumidifier": shared_values.get("has_dehumidifier", device_values.get("has_dehumidifier", False)),
        },
